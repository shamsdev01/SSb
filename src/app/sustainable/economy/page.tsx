          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            ...
            >
              ...
              <div className="space-y-4">
                ...
                <p>·Initiate 10 hectares Badagry mechanised farm for food crop production (Food 4 All) and procurement of farm machineries.</p>
                <p>·Train and empower 100 people yearly in fish farming and aquaculture value chain.</p>
                <p>·Establish a centralized modern processing centre for coconut oil and coconut products.</p>
                <p>·Under Badagry Rice initiative: Transform the abundant wetlands and marshland to rice farms and construction of rice processing and milling plants.</p>
                <p>·Engaging local engineers and artisans for direct labours and small-scale contracts under community infrastructure maintenance scheme (CIMS).</p>
                <p>·Build Badagry trade and commerce complex comprising offices, business chambers, Halls etc.</p>
              </div>
            </motion.div>
          </div>
        </motion.div>
